...
def execute(context):
    ...
    print("number of persons in egt %d" % (len(df_persons)))
    ...
    # commuting distance:  BYIN 4/2023
    df_persons["commuting_dist_egt"] = df_persons["DDOMTRAV"].replace(np.nan, 0).astype(np.float)
