...
def execute(context):
    ...
    # Finish up
    df_households = df_households[hts.HOUSEHOLD_COLUMNS + ["income_class"] + ["egt_household_id"] + ["ENERGV1_egt", "APMCV1_egt","ENERGV2_egt", "APMCV2_egt","ENERGV3_egt", "APMCV3_egt","ENERGV4_egt", "APMCV4_egt"]]  # BYIN 06-2023
    df_persons = df_persons[hts.PERSON_COLUMNS + ["egt_household_id", "egt_person_id"] + ["parking_at_workplace", "commuting_dist_egt"]]  # BYIN 04-2023
